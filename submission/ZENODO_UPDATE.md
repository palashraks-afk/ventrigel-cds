...
2. Click **New version**.
3. **Remove** the old PDF from the file list.
4. **Upload** these two files:
   - `paper/ventrigel_enrichment.pdf` — the rewritten manuscript
   - `CORRECTION.md` — the retraction notice (upload as-is; Zenodo renders Markdown)
...
> threshold corresponds to nothing in the data generator. Full details in `CORRECTION.md`.
>
...
> propagated. Results are reported as assurance — power integrated over effect and comparator
